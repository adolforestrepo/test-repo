 ...
 * </p>
 */
public class AstdArticleFilename implements TempWorkflowConstants {
	 ...
	 *            Article filename.
	 */
	public AstdArticleFilename(String name) {
	 ...
	 */
	public void setWorkflowVariables(WorkflowContext context)
			throws RSuiteException {
		context.setVariable(ATD_VAR_PUB_CODE, pubCode);
		context.setVariable(ATD_VAR_FULL_FILENAME,
				fullFileName);
		context.setVariable(ATD_VAR_SOURCE_FILENAME,
				sourceFileName);
		context.setVariable(ATD_VAR_ARTICLE_TYPE, type);
		context.setVariable(ATD_VAR_VOLUME_NUMBER,
				volume);
		context.setVariable(ATD_VAR_ISSUE, issue);
		context.setVariable(ATD_VAR_MONTH, issue);
		context.setVariable(ATD_VAR_SEQUENCE, sequence);
		context.setVariable(ATD_VAR_FILENAME_AUTHOR,
				author);
	}
