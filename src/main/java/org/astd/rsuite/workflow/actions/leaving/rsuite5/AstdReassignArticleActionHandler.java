...
//
//import com.reallysi.rsuite.api.workflow.activiti.AbstractWorkflowHandling;
//
//import com.reallysi.rsuite.api.workflow.activiti.WorkflowAction;
//
//
//
///**
...
//            String moid = (String) context.getVariable("rsuite contents");
...
//                //reportAndThrowRSuiteException(context, "MO is not a content assembly");
//                reportAndThrowRSuiteException("MO is not a content assembly");
//            }
//
//            ArticleFileName curName = null;
//            try {
//                curName = new ArticleFileName(mo.getDisplayName());
//            } catch (Exception e) {
...
//            
//            
//            if (StringUtils.isNotBlank(pubCode) ||  StringUtils.isEmpty(pubCode) ) {
//                pubCode = curName.pubCode;
//             }
//            
//            
