package org.astd.rsuite.container.visitor;
...
public class ListReferencedContentContainerVisitor
   ...
   * @param user
   */
  public ListReferencedContentContainerVisitor(
   ...
   * (non-Javadoc)
   * 
   * @see com.rsicms.rsuite.helpers.tree.impl.DefaultContentAssemblyVisitor#visitManagedObject(com.
   * reallysi .rsuite.api.ManagedObject)
   */
  @Override
