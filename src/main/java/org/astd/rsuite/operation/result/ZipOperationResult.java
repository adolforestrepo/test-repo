...
public class ZipOperationResult
  ...
  public ZipOperationResult(
      String operationId, String defaultLabel, Log log) {
   ...
   * (non-Javadoc)
   * 
   * @see org.ama_assn.rsuite.operation.result.OperationResult#incrementManagedObjectCreatedCount()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.ama_assn.rsuite.operation.result.OperationResult#getManagedObjectCreatedCount()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.ama_assn.rsuite.operation.result.OperationResult#incrementManagedObjectUpdatedCount()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.ama_assn.rsuite.operation.result.OperationResult#getManagedObjectUpdatedCount()
   */
  @Override
