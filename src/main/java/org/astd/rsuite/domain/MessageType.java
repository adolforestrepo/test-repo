...
public enum MessageType {
  INFO("info", GenericProcessInfoMessage.class),
  WARNING("warn", GenericProcessWarningMessage.class),
  FAILURE("error", GenericProcessFailureMessage.class),
  OTHER("other", ProcessMessage.class);

  private String label;
  private Class<? extends ProcessMessage> klass;

  private MessageType(
      String label, Class<? extends ProcessMessage> klass) {
    this.label = label;
    this.klass = klass;
  }
