...
def doctypesWithIdDeclarationDir = new File(doctypesDir, "conversion_configuration");
...
publicId = "urn:pubid:astd.com/doctypes/dita/conversion_configuration";
...
moDefList = [ 
                      ...
                      new ManagedObjectDefinition(['name' : 'fig',
                      'displayNameXPath': "if (*[contains(@class, ' topic/title ')]) then *[contains(@class, ' topic/title ')] else if (@title) then string(@title) else '(figure)'",
                      'versionable': 'true',
                      'reusable': 'true',
                      'browsable': 'true']),
                      
                      new ManagedObjectDefinition(['name' : 'table',
                      'displayNameXPath': "if (*[contains(@class, ' topic/title ')]) then *[contains(@class, ' topic/title ')] else if (@title) then string(@title) else '(table)'",
                      'versionable': 'true',
                      'reusable': 'true',
                      'browsable': 'true']),
                      
                      new ManagedObjectDefinition(['name' : 'subsection',
                      'displayNameXPath': "if (*[contains(@class, ' topic/title ')]) then *[contains(@class, ' topic/title ')] else if (@title) then string(@title) else '(subsection)'",
                      'versionable': 'true',
                      'reusable': 'true',
                      'browsable': 'true']),
                      
                      new ManagedObjectDefinition(['name' : 'task',
                      'displayNameXPath': "if (*[contains(@class, ' topic/title ')]) then *[contains(@class, ' topic/title ')] else if (@title) then string(@title) else '(task)'",
                      'versionable': 'true',
                      'reusable': 'true',
                      'browsable': 'true']),
